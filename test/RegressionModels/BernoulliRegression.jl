...
function test_BernoulliRegression_sklearn()
    ...
    base_model = BernoulliRegressionEmission(;
        input_dim=1,
        output_dim=1,
        include_intercept=true,
        β=reshape([0.5, 0.8], :, 1),
    ...
    regularized_model = BernoulliRegressionEmission(;
        input_dim=1,
        output_dim=1,
        include_intercept=true,
        β=reshape([0.5, 0.8], :, 1),
    ...
    weighted_model = BernoulliRegressionEmission(;
        input_dim=1,
        output_dim=1,
        include_intercept=true,
        β=reshape([0.5, 0.8], :, 1),
    ...
    rw_model = BernoulliRegressionEmission(;
        input_dim=1,
        output_dim=1,
        include_intercept=true,
        β=reshape([0.5, 0.8], :, 1),
