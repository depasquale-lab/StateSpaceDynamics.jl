    ...
    @testset verbose = true "Linear Dynamical Systems" begin
        ...
        @testset "SLDS" begin
            ...
            @testset "EM Algorithm" begin
                ...
                test_SLDS_infer_gamma_basic()
                test_SLDS_infer_gamma_shapes()
                test_SLDS_infer_gamma_deterministic_and_modes()
                test_SLDS_infer_gamma_K1()
                test_SLDS_infer_gamma_recovers_distinct_regimes()
